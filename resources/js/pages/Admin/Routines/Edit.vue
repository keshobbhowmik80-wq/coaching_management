...
const form = useForm({
    ...
    class_id: props.routine.class_id,
    section_id: props.routine.section_id,
    exam_id: props.routine.exam_id,
    starts_on: props.routine.starts_on || '',
...
function submit() {
    form.put(`/admin/routines/${props.routine.id}`);
}
</script>
    ...
    <div class="mx-auto max-w-3xl space-y-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-xl font-semibold">Edit Routine</h1>
            </div>
